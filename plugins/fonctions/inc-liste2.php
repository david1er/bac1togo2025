...
$pdf->ezStartPageNumbers(670, 15, 8, 'left', "$DateConvocPied - Page {PAGENUM} sur {TOTALPAGENUM}");
...
if (isset($_GET['id_etablissement'])) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $i++;
        $data[$i] = array('N°' => $id_candidat, 'dos' => $num_dossier, 'num_table' => $num_table, 'noms' => $candidat, 'sex' => $sexe, 'dldn' => $dldn, 'pdn' => utf8_decode($pdn), 'nat' => utf8_decode($nationalite), 'serie' => $serie, 'eps' => $eps . ' ' . $atelier, 'lv2' => $lv2, 'efa' => $efa, 'efb' => $efb, 'sig' => '', 'annee1' => $annee_bac1, 'jury1' => $jury_bac1, 'table1' => $num_table_bac1);
    }
