...
$pdf->ezText(utf8_decode("<b>BACCALAUREAT PREMIERE PARTIE (BAC 1)</b>"), 12, array('justification' => 'center'));
...
//    $pdf->addJpegFromFile("../images/logo.png",565,750,45);
    ...
    $pdf->ezSetY($height - 100);
    $pdf->ezText(utf8_decode("<b>BACCALAUREAT DE L'ENSEIGNEMENT SECONDAIRE</b>"), 13, array('justification' => 'center'));
    $mois = moisSession2($lien, $annee);
    $pdf->ezText(utf8_decode("<b>Session de $mois $annee\n</b>"), 11, array('justification' => 'center'));
