...
if (isset($_GET['jury'])) {
    ...
    if ($tache == 'classement_jury') {
        ...
        $limit = " LIMIT 0, 2000 ";
        $andTitre = " PAR ORDRE DE ALPHABETIQUE";

    } elseif ($tache == 'liste_absents_jury') {
        $andWhere .= " AND (res.delib1='Absent' OR res.delib1='Abandon') ";
        $orderBy = 'can.nom, can.prenoms';
        $andTitre = " DES ABSENTS du JURY";
    }
    ...
    $titre_tab = html_entity_decode("<b>LISTE $andTitre || CENTRE : " . strtoupper($centre) . " - JURY : " . $jury . " </b>");
