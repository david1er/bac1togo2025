...
$options = array(
    ...
    'cols' => array(
        ...
        'serie' => array('serie' => 'left', 'width' => 20),
    ),
);
...
if (isset($_GET['id_centre'])) {
    ...
    } elseif ($tache == 'affichage_definitive') {
        $andAdd = " ";
        $orderBy = 'ser.serie, rep.numero, can.nom ';
        $andTitre = " D'AFFICHAGE DEFINITIVE";
        $cols = array('num' => utf8_decode('N° TABLE'), 'noms' => 'CANDIDAT', 'dldn' => 'DATE ET LIEU DE NAISSANCE', 'sexe' => 'Sexe', 'eta' => 'ETABLISSEMENT', 'serie' => 'Serie', 'jr' => 'JURY', 'eps' => 'EPS', 'lv2' => 'LV2', 'efa' => 'EF. A', 'efb' => 'EF. B');
    ...
    } elseif ($tache == 'liste_additive') {
        $andAdd = " AND can.additive=1";
        $orderBy = 'ser.serie, rep.numero, can.nom ';
        $andTitre = "  D'AFFICHAGE DE LISTE ADDITIVE ";
        $cols = array('num' => utf8_decode('N° TABLE'), 'noms' => 'CANDIDAT', 'dldn' => 'DATE ET LIEU DE NAISSANCE', 'sexe' => 'Sexe', 'eta' => 'ETABLISSEMENT', 'serie' => 'Serie', 'jr' => 'JURY', 'eps' => 'EPS', 'lv2' => 'LV2', 'efa' => 'EF. A', 'efb' => 'EF. B');
    } else {
        $andAdd = "";
        $orderBy = 'rep.numero';
