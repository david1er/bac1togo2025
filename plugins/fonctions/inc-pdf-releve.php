            ...
            if (in_array($id_type_note, $tTypes[$num_table])) {
                ...
                foreach ($tMatieres[$num_table][$id_type_note] as $id_matiere => $matiere) {
                    ...
                    if ($id_type_note == 4) {
                        ...
                        // Pour tous les autres types de notes
...
$pdfG = "Releves_jury" . $jury . '_serie' . $serie;
...
$title = "Releves de candidats jury" . $jury . '_serie' . $serie . '_annee' . $annee;
