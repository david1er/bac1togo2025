...
while ($row = mysqli_fetch_array($result)) {
    ...
    $sql_effectif = "SELECT COUNT(id_candidat) AS effectif FROM bg_candidats WHERE statu=0 AND etablissement = $id";
...
$pdf->ezInsertMode(0);
$pdfG = "Effectif des rejets" . getRewriteString($j);

$title = "Effectif des rejets ";
