...
if(isset($_GET['id_centre'])) {
	...
	if($tache=='affichage') {
		$orderBy='ser.serie, rep.numero, can.nom '; $andTitre=" D'AFFICHAGE";
		...
		$orderBy='rep.numero'; $andTitre=" D'EMARGEMENT";
	...
	/********************************* */
	$delimiter=","; 
	$filename="candidats-data_".$tache."_".$id_centre."_".date('Y-m-d');
	...
	while($row=mysqli_fetch_array($result)){
		...
		/********************************* */
		$lineData=array($num_table,utf8_decode($candidat),utf8_decode($dldn),$sex,$etablissement,$serie,$jury,$eps,$langue_vivante,utf8_decode($epreuve_facultative_a),utf8_decode($epreuve_facultative_b));
