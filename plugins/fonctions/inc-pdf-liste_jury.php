...
$pdf->ezStartPageNumbers(10, 20, 8, 'right', "REPUBLIQUE TOGOLAISE - $direction - $DateConvocPied - PAGE {PAGENUM} sur {TOTALPAGENUM}");

$options = array('maxWidth' => 430);
...
$pdf->ezText(utf8_decode("\n\n<b>$libelle_examen </b>"), 11, array('justification' => 'center'));
...
$texte = "LES CANDIDATS SUIVANTS SONT ";
...
$pdf->ezText(utf8_decode("$chefLieu, le $date_delib"), 11, array('justification' => 'right'));
$pdf->ezText(utf8_decode("\n\n\n\n<b><u>LE PRESIDENT DU JURY</u></b>\n\n\n\n$president_jury\n"), 11, array('justification' => 'center'));
