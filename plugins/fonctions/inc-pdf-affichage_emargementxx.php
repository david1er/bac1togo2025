...
if (isset($_GET['id_centre'])) {
    ...
    if ($tache == 'affichage') {
        ...
        $cols = array('num' => utf8_decode('N° TABLE'), 'noms' => 'CANDIDAT', 'dldn' => 'DATE ET LIEU DE NAISSANCE', 'eta' => 'ETABLISSEMENT', 'serie' => 'SERIE', 'jr' => 'JURY', 'eps' => 'EPS', 'lv2' => 'LV2', 'efa' => 'EF. A', 'efb' => 'EF. B');
    } elseif ($tache == 'emargement') {
        $orderBy = 'rep.numero';
        $andTitre = " D'EMARGEMENT";
        $cols = array('num' => utf8_decode('N° TABLE'), 'noms' => 'CANDIDAT', 'dldn' => 'DATE ET LIEU DE NAISSANCE', 'eta' => 'ETABLISSEMENT', 'serie' => 'SERIE', 'jr' => 'JURY', 'eps' => 'EPS', 'lv2' => 'LV2', 'efa' => 'EF. A', 'efb' => 'EF. B', 'sig' => '     EMARGEMENT   ');
    } else {
        $orderBy = 'rep.numero';
        $andTitre = " D'EMARGEMENT";
        $cols = array('num' => utf8_decode('N° TABLE'), 'noms' => 'CANDIDAT', 'dldn' => 'DATE ET LIEU DE NAISSANCE', 'emarg1' => '1ERE DEMI JOURNEE', 'emarg2' => '2IEME DEMI JOURNEE', 'emarg3' => '3IEME DEMI JOURNEE', 'emarg4' => '4IEME DEMI JOURNEE', 'emarg5' => '5IEME DEMI JOURNEE', 'emarg6' => '6IEME DEMI JOURNEE');
    }
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $eps .= ' ' . $atelier;
        $data[] = array('num' => $num_table, 'noms' => utf8_decode($candidat), 'dldn' => utf8_decode($dldn), 'eta' => $etablissement, 'serie' => $serie, 'jr' => $jury, 'eps' => $eps, 'lv2' => $langue_vivante, 'efa' => $epreuve_facultative_a, 'efb' => $epreuve_facultative_b);
    }
